...
namespace HRManagement.Migrations
{
    ...
    [Migration("20250713152130_editTheREviewedByInLEaveRequest")]
    partial class editTheREviewedByInLEaveRequest
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HRManagement.AttendanceLogs.AttendanceLog", b =>
                {
                    b.Property<Guid>("Id")
                    ...
                    b.ToTable("AppAttendanceLogs", (string)null);
                });

            modelBuilder.Entity("HRManagement.Employees.Employee", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("HRManagement.HRManagers.HRManager", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("HRManagement.LeaveRequests.LeaveRequest", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<int>("LeaveRequestStatus")
                        .HasColumnType("int")
                        .HasColumnName("LeaveRequestStatus");
            ...
            modelBuilder.Entity("HRManagement.PayrollRecords.PayrollRecord", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("AppPayrollRecords", (string)null);
                });
            ...
            modelBuilder.Entity("HRManagement.AttendanceLogs.AttendanceLog", b =>
                {
                    b.HasOne("HRManagement.Employees.Employee", null)
                        .WithMany()
            ...
            modelBuilder.Entity("HRManagement.LeaveRequests.LeaveRequest", b =>
                {
                    ...
                    b.HasOne("HRManagement.HRManagers.HRManager", null)
                        .WithMany()
