...
namespace HRManagement.EntityFrameworkCore.Domains.LeaveRequests
{
    public class LeaveRequestRepositoryTests : HRManagementEntityFrameworkCoreTestBase
    {
        ...
        public async Task GetListAsync()
        {
            ...
            await WithUnitOfWorkAsync(async () =>
            {
                ...
                result.First().Id.ShouldBe(Guid.Parse("bffcad48-3c25-419a-9b9b-ef7023dc4f66"));
            });
        }
