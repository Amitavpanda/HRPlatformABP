...
[DependsOn(
    typeof(HRManagementApplicationTestModule),
    typeof(HRManagementEntityFrameworkCoreModule),
    typeof(AbpEntityFrameworkCoreSqliteModule)
)]
public class HRManagementEntityFrameworkCoreTestModule : AbpModule
{
    ...
    private static SqliteConnection CreateDatabaseAndGetConnection()
    {
        ...
        using (var context = new HRManagementDbContext(options))
        {
